...
function mash_choice() {  // New function called mash_choice that doesn't take any parameters 
  ...
  var mash = ['Stark', 'Lannister', 'Targaryen', 'Baratheon'];  // The array of choices to pick from 
...
function fill_in_answers(answers) {
  ...
  // Fill them with the provided answers
    ...
    name.innerText = answers['name'];
    dead.innerText = answers['dead'];
    ...
    name.innerHTML = answers.name;  // Change the content of the element in the HTML doc         with the id "career" to the "career" value in answers 
    dead.innerHTML = answers.dead;
